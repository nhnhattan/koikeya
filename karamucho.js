const item = [
    {
        ...
        description: [
            ...
            "Khoai tây tươi cắt lát V-cut giòn tan hòa quyện cùng vị chua cay mặn ngọt đặc trưng của dòng sản phẩm Karamucho, lát bánh dày hơn lát mỏng nên gia vị thấm đều gia vị vào từng khe cắt, rất phù hợp với những ai thích ăn lát bánh dày và đậm vị.",
        ],
    ...
    },
    {
        ...
        description: [
            "Vị cay ở mức độ trung bình, phù hợp với mọi lứa tuổi và đối tượng khách hàng.",
            "Khoai tây tươi cắt lát V-cut giòn tan hòa quyện cùng vị chua cay mặn ngọt đặc trưng của dòng sản phẩm Karamucho, lát bánh dày hơn lát mỏng nên gia vị thấm đều gia vị vào từng khe cắt, rất phù hợp với những ai thích ăn lát bánh dày và đậm vị.",
            "Lát bánh hòa quyện cùng vị sốt Sriracha đặc trưng của Thái Lan, đây là 1 loại tương ớt đặc trưng trong hầu hết các món ăn của Thái.",
        ],
        title: "Snack khoai tây Karamucho Strong Lát dày",
    ...
    },
    {
        ...
        taste: "Vị cay đặc biệt (25g) - (44g) - (82g) - (120g)",
        energy: "525,2 kcal",
        protein: "8,1g",
    ...
    },
    {
        ...
        description: [
            "Vị cay ở mức độ trung bình, phù hợp với mọi lứa tuổi và đối tượng khách hàng.",
            "Khoai tây tươi cắt lát mỏng giòn tan hòa quyện cùng vị chua cay mặn ngọt kết hợp với lát rong biển cắt nhỏ phủ đều lát bánh.",
        ],
        title: "Snack khoai tây Karamucho",
    ...
    },
    {
        ...
        description: [
            "Vị cay ở mức độ trung bình hòa quyện thêm chút vị ngọt tạo nên vị sốt cay ngọt rất bắt miệng. Đây là loại sốt Yangyeom - loại sốt cực kì nổi tiếng được dùng trên hầu hết các món gà rán tại Hàn Quốc.",
            "Khoai tây tươi cắt lát mỏng giòn tan hòa quyện cùng vị chua cay mặn ngọt đặc trưng của dòng sản phẩm Karamucho.",
        ],
        title: "Snack khoai tây Karamucho",
    ...
    },
    {
        ...
        description: [
            "Vị cay ở mức độ trung bình, phù hợp với mọi lứa tuổi và đối tượng khách hàng.",
            "Bánh được làm từ 100% bắp nguyên chất xát nhuyễn, không phải làm bằng bột bắp nên lát bánh giòn, xốp , không bị cứng. Bên trên lát bánh phủ đều gia vị khô bò, đây là 1 trong những vị truyền thống của Việt Nam và rất được ưa chuộng.",
        ],
        ...
        allergy: "Sản phẩm không phù hợp cho người dị ứng với sữa, đậu nành."
    },
    {
        id: 7,
    ...
    },
    {
        ...
        description: [
            "Vị cay ở mức độ trung bình, phù hợp với mọi lứa tuổi và đối tượng khách hàng.",
            "Bánh được làm từ 100% bắp nguyên chất xát nhuyễn, không phải làm bằng bột bắp nên lát bánh giòn, xốp , không bị cứng.",
        ],
        title: "Snack bắp Karamucho",
...
$(document).ready(function () {
    ...
    function updateButtons() {
        ...
        if ($(window).width() <= 740) {
            if (scrollLeft + $(".scroll-container").width() >= 4349) {
                $("#scroll-right").addClass("disable");
            } else {
                $("#scroll-right").removeClass("disable");
            }
        } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
            if (scrollLeft + $(".scroll-container").width() >= 3399.305083984375) {
                $("#scroll-right").addClass("disable");
            } else {
                $("#scroll-right").removeClass("disable");
            }
        } else {
            if (scrollLeft + $(".scroll-container").width() >= 3300) {
                $("#scroll-right").addClass("disable");
            } else {
                $("#scroll-right").removeClass("disable");
            }
        ...
        switch (this.id) {
            case "item1":
                if ($(window).width() <= 740) {
                    ...
                    $("#border-product").css({left: "calc(-5.4%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(0%)", width: "25%"});
                } else {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(2%)", width: "25%"});
                }
            ...
            case "item2":
                if ($(window).width() <= 740) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(23%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(25.5%)", width: "25%"});
                } else {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(26%)", width: "25%"});
                }
            ...
            case "item3":
                if ($(window).width() <= 740) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(51%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(51%)", width: "25%"});
                } else {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(50%)", width: "25%"});
                }
            ...
            case "item4":
                if ($(window).width() <= 740) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(79%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(75.5%)", width: "25%"});
                } else {
                    $("#border-product-2").css({width: "0px"});
                    $("#border-product").css({left: "calc(73%)", width: "25%"});
                }
                $(".product-left_img img").attr("src", item[3].img);
                $("#item-title").text(item[3].fullName);
                if (typeof item[3].description === "object") {
                    $(".table-item .text").text("");
                    $(".table-item .text").empty("");
            ...
            case "item5":
                if ($(window).width() <= 740) {
                    $("#border-product-2").css({left: "calc(-5.4%)", width: "25%"});
                    $("#border-product").css({width: "0px"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product-2").css({left: "calc(0%)", width: "25%"});
                    $("#border-product").css({width: "0px"});
                } else {
                    $("#border-product-2").css({left: "calc(2%)", width: "25%"});
                    $("#border-product").css({width: "0px"});
                }
                ...
                if (typeof item[4].description === "object") {
                    ...
                    $(".item .text").text(item[4].description);
                }
            ...
            case "item6":
                if ($(window).width() <= 740) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(23%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(25.5%)", width: "25%"});
                } else {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(25.5%)", width: "25%"});
                }
                ...
                if (typeof item[5].description === "object") {
                    $(".table-item .text").text("");
                    $(".table-item .text").empty("");
                    $(".table-item .text").append(`<p>${item[5].description[0]}</p>`);
                    $(".table-item .text").append(`<p>${item[5].description[1]}</p>`);
                } else {
                    $(".item .text").text(item[5].description);
                }
            ...
            case "item7":
                if ($(window).width() <= 740) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(51%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(51%)", width: "25%"});
                } else {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(49.5%)", width: "25%"});
                }
                $(".product-left_img img").attr("src", item[6].img);
                $("#item-title").text(item[6].fullName);
                if (typeof item[6].description === "object") {
                    $(".table-item .text").text("");
                    $(".table-item .text").empty("");
                    $(".table-item .text").append(`<p>${item[6].description[0]}</p>`);
                    $(".table-item .text").append(`<p>${item[6].description[1]}</p>`);
                } else {
                    $(".item .text").text(item[6].description);
                }
            ...
            case "item8":
                if ($(window).width() <= 740) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(79%)", width: "25%"});
                } else if ($(window).width() >= 740 && $(window).width() <= 1023) {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(75.5%)", width: "25%"});
                } else {
                    $("#border-product").css({width: "0px"});
                    $("#border-product-2").css({left: "calc(73%)", width: "25%"});
                }
                $(".product-left_img img").attr("src", item[7].img);
                $("#item-title").text(item[7].fullName);
                if (typeof item[7].description === "object") {
                    $(".table-item .text").text("");
                    $(".table-item .text").append(`<p>${item[7].description[0]}</p>`);
                    $(".table-item .text").append(`<p>${item[7].description[1]}</p>`);
                } else {
                    $(".item .text").text(item[7].description);
                }
        ...
        switch (items.eq(index)[0].id) {
            ...
            case "item8":
                ...
                if (typeof item[7].description === "object") {
                    ...
                    $(".table-item .text").append(`<p>${item[7].description[0]}</p>`);
                    $(".table-item .text").append(`<p>${item[7].description[1]}</p>`);
                    $(".table-item .text").append(`<p>${item[7].description[2]}</p>`);
                } else {
                    $(".item .text").text(item[7].description);
                }
                $(".table-head .table-title_large:first-child").text(item[7].title);
...
$(document).ready(function () {
    ...
    var container1Height = $container1.height() - 250;
    var container1Height = $container1.height() - 250;
